...
const char *wifi_ssid = "iphone de k1000";
...
void setup()
{
  ...
  {
    mqtt_client.publish("TD02_GP07/temp", String(event.temperature).c_str());
    mqtt_client.publish("TD02_GP07/relhum", String(event.relative_humidity).c_str());
  }
